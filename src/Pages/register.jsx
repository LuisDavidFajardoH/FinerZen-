...
import { Button, TextField, Container, Typography, Box, Paper, FormControl, InputLabel, Select, MenuItem, FormHelperText } from '@mui/material';
      ...
      <Container maxWidth="sm">
        <Paper elevation={6} sx={{
          ...
          <Box component="form" onSubmit={handleSubmit} sx={{ mt: 3 }}>
            ...
            <FormControl fullWidth margin="normal">
              <InputLabel id="company-label">¿Pertenece a una empresa?</InputLabel>
              <Select
              ...
              <FormHelperText>Indica si perteneces a una empresa</FormHelperText>
              {isFromCompany === 'Sí' && (
              <TextField
                margin="normal"
                required
            ...
            <Typography variant="body2" sx={{ mt: 2, mb: 1 }}>
              Al registrarte, aceptas el uso de tus datos personales conforme a nuestra Política de Privacidad.
            </Typography>
            <Button
              type="submit"
              fullWidth
